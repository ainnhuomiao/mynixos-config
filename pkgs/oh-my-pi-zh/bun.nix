...
}:
{
  ...
  "@huggingface/hub@2.13.3" = fetchurl {
    url = "https://registry.npmjs.org/@huggingface/hub/-/hub-2.13.3.tgz";
    hash = "sha512-qAEbZ0x1vUQIUSComJ5EPgII+eI3nJB3gTPNTzjir6Kk/aCHHvPfCNMreS4iUg6gT17YDkvt7XBTndzh7617KQ==";
  };
  ...
  "@huggingface/tasks@0.21.28" = fetchurl {
    url = "https://registry.npmjs.org/@huggingface/tasks/-/tasks-0.21.28.tgz";
    hash = "sha512-PCduFL8/f3VfBIIY+fnjcBfRTLgsWHBWJls1xcYRNkJM4iKpwWfEsFnsH/4YP678zZRieNbTh8JUBP9/1NgMbg==";
  };
  ...
  "@oh-my-pi/collab-web" = copyPathToStore (__OH_MY_PI_SRC__ + "/packages/collab-web");
  "@oh-my-pi/hashline" = copyPathToStore (__OH_MY_PI_SRC__ + "/packages/hashline");
  "@oh-my-pi/omp-stats" = copyPathToStore (__OH_MY_PI_SRC__ + "/packages/stats");
  "@oh-my-pi/pi-agent-core" = copyPathToStore (__OH_MY_PI_SRC__ + "/packages/agent");
  "@oh-my-pi/pi-ai" = copyPathToStore (__OH_MY_PI_SRC__ + "/packages/ai");
  "@oh-my-pi/pi-catalog" = copyPathToStore (__OH_MY_PI_SRC__ + "/packages/catalog");
  "@oh-my-pi/pi-coding-agent" = copyPathToStore (__OH_MY_PI_SRC__ + "/packages/coding-agent");
  "@oh-my-pi/pi-metaharness" = copyPathToStore (__OH_MY_PI_SRC__ + "/packages/metaharness");
  "@oh-my-pi/pi-mnemopi" = copyPathToStore (__OH_MY_PI_SRC__ + "/packages/mnemopi");
  "@oh-my-pi/pi-natives" = copyPathToStore (__OH_MY_PI_SRC__ + "/packages/natives");
  "@oh-my-pi/pi-tui" = copyPathToStore (__OH_MY_PI_SRC__ + "/packages/tui");
  "@oh-my-pi/pi-utils" = copyPathToStore (__OH_MY_PI_SRC__ + "/packages/utils");
  ...
  "electron-to-chromium@1.5.396" = fetchurl {
    url = "https://registry.npmjs.org/electron-to-chromium/-/electron-to-chromium-1.5.396.tgz";
    hash = "sha512-yHiw2Y3C3H9U6TMbOfoWK/BPreiOPXRfTWPBwQBoZG6/8TB6eOPnsy5oaRYuatR7Fw2SJ4kKforgufeo7fq0EQ==";
  };
  "emnapi@1.11.2" = fetchurl {
    url = "https://registry.npmjs.org/emnapi/-/emnapi-1.11.2.tgz";
    hash = "sha512-iMt/XQc69fFn2EvcU6tm14HmXKwyy0lnABugsQlqp6xFuZIUuO+ONVSg2mz+MTVF8WbC+bic65AvRXdoldALKg==";
  };
  ...
  "generative-bayesian-network@2.1.86" = fetchurl {
    url = "https://registry.npmjs.org/generative-bayesian-network/-/generative-bayesian-network-2.1.86.tgz";
    hash = "sha512-4+cZAUH6khje/EUKRlTlO+HpjA7aqvDlVBnBSJKZqC6qiJ3EitNZ97//xYrBbawZCHe1S1PGLza6knQTFpWCgw==";
  };
  ...
  "header-generator@2.1.86" = fetchurl {
    url = "https://registry.npmjs.org/header-generator/-/header-generator-2.1.86.tgz";
    hash = "sha512-Nj+glwXBEU3PvvAT1WiC3FBhX1ReZZY+ADXIo2iTRqMzamLW0olJk7q/EJ6N3qJBqQWZJDJonAJRtAlzEFynLQ==";
  };
  ...
  "lint-staged@17.2.0" = fetchurl {
    url = "https://registry.npmjs.org/lint-staged/-/lint-staged-17.2.0.tgz";
    hash = "sha512-FchGnFe4i4B1C/a35SPU9bNGPEHSC1+1iV0plLjzBmKVe9klZrlRfSgK6Cw4VeHyqOXbJUXP0vON61uRftNQ0A==";
  };
  ...
  "lucide-react@1.26.0" = fetchurl {
    url = "https://registry.npmjs.org/lucide-react/-/lucide-react-1.26.0.tgz";
    hash = "sha512-raglYVR2+VkMfJL158krjVmE+rV5ST2lzA/KQm1FRSjMHT4MnWaegHxoVEpmc2So3nOEhp9oGejJwAPX8MoAjg==";
  };
  ...
  "robomp-web" = copyPathToStore (__OH_MY_PI_SRC__ + "/python/robomp/web");
  ...
  "vite-plugin-solid@2.11.13" = fetchurl {
    url = "https://registry.npmjs.org/vite-plugin-solid/-/vite-plugin-solid-2.11.13.tgz";
    hash = "sha512-YaCNMzwIawUO8K16uj5jaxUJIYCstBEjkUppC5OKElBz/K2+R7Q7MWycHDgqzjBca5WWy/2ZQQ45IHexaabYew==";
  };
  "vite@8.1.5" = fetchurl {
